...
#[allow(unused_imports)]
pub(crate) use wire::{
    AlarmMessage, AlarmResult, AxisPosition, DiagnosisValue, FocasClient, MacroValue,
    OperatorMessage, ParamValue, PmcArea, PmcScalarValue, SpindleSpeed, SpindleWord, StatusInfo,
    SystemInfo,
};
